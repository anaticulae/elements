...
HEADLINES = set(ABBREVIATION + ABSTRACT + ACKNOWLEDGE + APPENDIX +
                BIBLIOGRAPHY + CHAPTER + FIGURETABLE + GLOSSARY + LEGAL +
                SYMBOLTABLE + TABLETABLE + TOC + UTILS + VITAE + LISTINGS)
